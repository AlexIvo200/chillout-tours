...
const DICT = {
  ru: {
    ...
    'map.hint': 'Наведите на точку маршрута или потяните карту',
  ...
  en: {
    ...
    'map.hint': 'Hover a stop or drag the map',
    'map.open': 'Open tour',
    ...
    'map.start': 'Where every tour starts',
